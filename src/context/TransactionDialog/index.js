...
function Pending({ children }) {
    ...
    return (
        <CardTX align='center'>
            ...
            <PendingCircular />
            <WhiteSpace size='gl' />
            <TitleText>{t("Waiting For confirmation")}</TitleText>
            <WhiteSpace size='gl' />
            {children}
            <WhiteSpace size='gl' />
        </CardTX>
...
function Fail({ children }) {
    ...
    return (
        <CardTX align='center'>
            ...
            <WhiteSpace size='xxl' />
            <TitleText>{t("Transaction FAIL")}</TitleText>
            <WhiteSpace size='gl' />
            {children}
            <WhiteSpace size='gl' />
        </CardTX>
...
function Loading({ children }) {
    ...
    return (
        <CardTX align='center'>
            <WhiteSpace size='gl' />
            <SIcon style={{ color: '#888' }} type='z-await' />
            <WhiteSpace size='gl' />
            <TitleText>{t("Transaction LOADING")}</TitleText>
            <WhiteSpace size='gl' />
            {children}
            <WhiteSpace size='gl' />
        </CardTX>
            ...
            >
                <TransactionDome>
                    <CloseButton onClick={closeTransaction}>
                        <Icon size='24' style={{ color: '#909090' }} type='z-tubiao-24' />
                    </CloseButton>
                    <Content>
                        {transaction.content}
                    </Content>
